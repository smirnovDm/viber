        ...
        <div class="bg-gray-200 pt-2 font-mono my-16 rounded">
            <div class="container mx-auto">
                <div class="inputs w-full max-w-2xl p-6 mx-auto">
                    ...
                    <form class="mt-6 border-t border-gray-400 pt-4" method="POST" action="{{ route('patterns.update', $pattern) }}">
                        {{method_field('PUT')}}
                        @csrf
                        <div class='flex flex-wrap -mx-3 mb-6'>
                            <div class='w-full md:w-full px-3 mb-6'>
                                ...
                                <input class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-1' name="theme" value="{{$pattern->theme}}" type='text' placeholder='Тема сообщения' required>
                            </div>

                            <div class='w-full md:w-full px-3 mb-6'>
                                <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2' for='grid-text-2'>Тег:</label>
                                <input class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500' id='grid-text-2' name="tag" value="{{$pattern->tag}}" type='text' placeholder='Тег' required>
                            </div>
